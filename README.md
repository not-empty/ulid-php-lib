...
```sh
docker build --build-arg PHP_VERSION=7.3.33-cli -t not-empty/ulid-php-lib:php73 -f contrib/Dockerfile .
```

Access the container
```sh
docker run -v ${PWD}/:/var/www/html -it not-empty/ulid-php-lib:php73 bash
```
